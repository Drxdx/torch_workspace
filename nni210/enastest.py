...
search_train_loader = DataLoader(train_data, batch_size=64, num_workers=1,sampler=SubsetRandomSampler(indices[:split]),)
search_valid_loader = DataLoader(train_data, batch_size=64, num_workers=1,sampler=SubsetRandomSampler(indices[split:]),)

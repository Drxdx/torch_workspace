...
def main():
    ...
    parser.add_argument("--disable-dp", action="store_true", default=True,help="Disable privacy training and just train with vanilla SGD", )
    ...
    exported_arch = torch.load('/home/xuedaxuan/torch_workspace/nni210/exported_arch/exported_arch_enas_8OPS_AmoebaNet_50.pth')
    with fixed_arch(exported_arch):
        final_model = EnasSpace(width=16, num_cells=6, dataset='cifar')

...
*   Create a new experiment with the default port 8080: ::
        ...
        nnictl create --config nni/examples/trials/mnist-pytorch/config.yaml

*   Create a new experiment with specified port 8088: ::

        nnictl create --config nni/examples/trials/mnist-pytorch/config.yaml --port 8088

*   Create a new experiment with specified port 8088 and debug mode: ::

        nnictl create --config nni/examples/trials/mnist-pytorch/config.yaml --port 8088 --debug

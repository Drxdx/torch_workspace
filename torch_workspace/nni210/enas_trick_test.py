...
print("ARCH is :  ",exported_arch)
torch.save(exported_arch, '/home/xuedaxuan/torch_workspace/nni210/exported_arch/exported_arch_enas_trick_10OPS_50_GN8_fixAdapt.pth')
...
with fixed_arch(exported_arch):
    final_model = EnasSpace(width=16, num_cells=6, dataset='cifar', auxiliary_loss=True, drop_path_prob=0.2)
